...
<div class="input-box">
            ...
            <input type="text" name="myInput" value=""required placeholder="Enter your Admin Id" >
</div>
<div class="input-box">
            <span class="details">Password</span>
            <input name="password" type="password" value=""required placeholder="Enter your password"/>
</div>
</div>
<div class="button">
